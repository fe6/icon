/**
 * @format
 * @file BytedAddMode byted-add-mode
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedAddModeSvgHtml = (props: IIconProps) =>
...
// 默认导出组件
export default IconWrapper('byted-add-mode', false, getIconBytedAddModeSvgHtml);
