/**
 * @format
 * @file BytedPhoneIncomingOne byted-phone-incoming-one
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedPhoneIncomingOneSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  'byted-phone-incoming-one',
  false,
  getIconBytedPhoneIncomingOneSvgHtml,
);
