/**
 * @format
 * @file BytedOneOne byted-one-one
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedOneOneSvgHtml = (props: IIconProps) =>
...
// 默认导出组件
export default IconWrapper('byted-one-one', false, getIconBytedOneOneSvgHtml);
