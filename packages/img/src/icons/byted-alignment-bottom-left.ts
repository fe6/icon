/**
 * @format
 * @file BytedAlignmentBottomLeft byted-alignment-bottom-left
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedAlignmentBottomLeftSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  ...
  false,
  getIconBytedAlignmentBottomLeftSvgHtml,
);
