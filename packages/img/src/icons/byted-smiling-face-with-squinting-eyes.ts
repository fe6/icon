/**
 * @format
 * @file BytedSmilingFaceWithSquintingEyes byted-smiling-face-with-squinting-eyes
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedSmilingFaceWithSquintingEyesSvgHtml = (
  props: IIconProps,
) =>
...
export default IconWrapper(
  'byted-smiling-face-with-squinting-eyes',
  false,
  getIconBytedSmilingFaceWithSquintingEyesSvgHtml,
);
