/**
 * @format
 * @file BytedArrowLeftDown byted-arrow-left-down
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedArrowLeftDownSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  'byted-arrow-left-down',
  false,
  getIconBytedArrowLeftDownSvgHtml,
);
