/**
 * @format
 * @file BytedAlignmentTopLeft byted-alignment-top-left
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedAlignmentTopLeftSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  'byted-alignment-top-left',
  false,
  getIconBytedAlignmentTopLeftSvgHtml,
);
