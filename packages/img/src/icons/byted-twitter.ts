/**
 * @format
 * @file BytedTwitter byted-twitter
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedTwitterSvgHtml = (props: IIconProps) =>
...
// 默认导出组件
export default IconWrapper('byted-twitter', false, getIconBytedTwitterSvgHtml);
