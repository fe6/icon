/**
 * @format
 * @file BytedMenuUnfoldOne byted-menu-unfold-one
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedMenuUnfoldOneSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  'byted-menu-unfold-one',
  false,
  getIconBytedMenuUnfoldOneSvgHtml,
);
