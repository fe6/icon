/**
 * @format
 * @file BytedConnectionPointTwo byted-connection-point-two
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedConnectionPointTwoSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  'byted-connection-point-two',
  false,
  getIconBytedConnectionPointTwoSvgHtml,
);
