/**
 * @format
 * @file BytedAlignmentLeftBottom byted-alignment-left-bottom
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedAlignmentLeftBottomSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  ...
  false,
  getIconBytedAlignmentLeftBottomSvgHtml,
);
