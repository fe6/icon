/**
 * @format
 * @file BytedDropShadowRight byted-drop-shadow-right
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedDropShadowRightSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  'byted-drop-shadow-right',
  false,
  getIconBytedDropShadowRightSvgHtml,
);
