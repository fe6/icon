...
// 获取 SVG 的 HTML 字符串
export const getIconBytedReloadSvgHtml = (props: IIconProps) =>
...
// 默认导出组件
export default IconWrapper('byted-reload', false, getIconBytedReloadSvgHtml);
