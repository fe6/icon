/**
 * @format
 * @file BytedPhoneOutgoingOne byted-phone-outgoing-one
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedPhoneOutgoingOneSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  ...
  false,
  getIconBytedPhoneOutgoingOneSvgHtml,
);
