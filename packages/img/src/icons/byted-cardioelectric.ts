/**
 * @format
 * @file BytedCardioelectric byted-cardioelectric
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedCardioelectricSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  'byted-cardioelectric',
  false,
  getIconBytedCardioelectricSvgHtml,
);
