/**
 * @format
 * @file BytedRoundDistortion byted-round-distortion
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedRoundDistortionSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  'byted-round-distortion',
  false,
  getIconBytedRoundDistortionSvgHtml,
);
