/**
 * @format
 * @file BytedLevelSevenTitle byted-level-seven-title
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedLevelSevenTitleSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  'byted-level-seven-title',
  false,
  getIconBytedLevelSevenTitleSvgHtml,
);
