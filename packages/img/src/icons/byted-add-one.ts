/**
 * @format
 * @file BytedAddOne byted-add-one
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedAddOneSvgHtml = (props: IIconProps) =>
...
// 默认导出组件
export default IconWrapper('byted-add-one', false, getIconBytedAddOneSvgHtml);
