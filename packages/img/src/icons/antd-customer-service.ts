/**
 * @format
 * @file AntdCustomerService customer-service
 * @author 由 fe6 自动生成
 */
...
export default IconWrapper(
  ...
  false,
  getIconAntdCustomerServiceSvgHtml,
);
