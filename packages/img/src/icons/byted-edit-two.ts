/**
 * @format
 * @file BytedEditTwo byted-edit-two
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedEditTwoSvgHtml = (props: IIconProps) =>
...
// 默认导出组件
export default IconWrapper('byted-edit-two', false, getIconBytedEditTwoSvgHtml);
