/**
 * @format
 * @file BytedMultiTriangularThree byted-multi-triangular-three
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedMultiTriangularThreeSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  'byted-multi-triangular-three',
  false,
  getIconBytedMultiTriangularThreeSvgHtml,
);
