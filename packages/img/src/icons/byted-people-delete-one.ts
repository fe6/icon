/**
 * @format
 * @file BytedPeopleDeleteOne byted-people-delete-one
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedPeopleDeleteOneSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  'byted-people-delete-one',
  false,
  getIconBytedPeopleDeleteOneSvgHtml,
);
