/**
 * @format
 * @file BytedIcecreamFour byted-icecream-four
 * @author 由 fe6 自动生成
 */
...
<svg width="${props.size}" height="${
  ...
  <g clip-path="${`url(#${props.id}img0)`}">
    ...
    <path d="M38.8216 15.3163C36.0094 16.7468 33.9207 16.0723 31.8483 13.9999" stroke="${
      props.colors?.[0]
    }" stroke-width="${props.strokeWidth}" stroke-linecap="${
    props.strokeLinecap
  }" stroke-linejoin="${props.strokeLinejoin}"/>
...
export default IconWrapper(
  'byted-icecream-four',
  false,
  getIconBytedIcecreamFourSvgHtml,
);
