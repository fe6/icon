/**
 * @format
 * @file BytedInternalExpansion byted-internal-expansion
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedInternalExpansionSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  ...
  false,
  getIconBytedInternalExpansionSvgHtml,
);
