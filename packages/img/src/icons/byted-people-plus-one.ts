/**
 * @format
 * @file BytedPeoplePlusOne byted-people-plus-one
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedPeoplePlusOneSvgHtml = (props: IIconProps) =>
...
export default IconWrapper(
  'byted-people-plus-one',
  false,
  getIconBytedPeoplePlusOneSvgHtml,
);
