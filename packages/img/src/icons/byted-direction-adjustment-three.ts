/**
 * @format
 * @file BytedDirectionAdjustmentThree byted-direction-adjustment-three
 * @author 由 fe6 自动生成
 */
...
// 获取 SVG 的 HTML 字符串
export const getIconBytedDirectionAdjustmentThreeSvgHtml = (
  props: IIconProps,
) =>
...
export default IconWrapper(
  ...
  false,
  getIconBytedDirectionAdjustmentThreeSvgHtml,
);
