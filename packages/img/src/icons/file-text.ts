...
// 获取 SVG 的 HTML 字符串
export const getIconFileTextSvgHtml = (props: ISvgIconProps) =>
  `<?xml version="1.0" encoding="UTF-8"?>
<svg width="${props.size}" height="${props.size}" fill="${props.colors[0]}" aria-hidden="true" viewBox="64 64 896 896" xmlns="http://www.w3.org/2000/svg">
