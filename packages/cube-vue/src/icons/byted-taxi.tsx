...
export default IconWrapper('byted-taxi', false, (props: ISvgIconProps) => (
    ...
    <g
      ...
      <g>
        <g transform="translate(4.000000, 11.000000)">
          ...
          />
          <circle fill={props.colors[2]} cx="9.5" cy="19.5" r="2.5" />
          <circle fill={props.colors[2]} cx="30.5" cy="19.5" r="2.5" />
        </g>
        <path
